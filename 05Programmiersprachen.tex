...
In Dart kann der Typ  \glq Typedef\grq{} verwendet werden, um eine Methodensignatur zu definieren und eine Instanz davon in einer Variablen zu vorzuhalten. \footcite[Vgl. ][Abgerufen am \today]{Pedley2019}  Dies wird in Quelltext \ref{lst:DartDelegates} dargestellt. 
...
aufgehoben.  Der Quelltext lässt sich trotz asynchroner Entwicklung weiterhin wie eine Folge von Anweisungen lesen, wird aber in der Praxis möglicherweise in einer deutlich komplizierteren Reihenfolge ausgeführt. die auf einer externen Ressourcenzuordnung und dem Abschluss von Aufgaben basiert. \footcite[Vgl. ][Abgerufen am \today]{MicrosoftAsyncAwait2020} 
