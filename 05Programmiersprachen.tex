...
Tabelle \ref{tab:Datatypes} zeigt eine Gegenüberstellung von \Csharp und Dart Datentypen.
\begin{table}[!ht]
...
Im Gegensatz zu \Csharp steht bei Dart keine Auswahl an Integer-Typen von 8 bis 64 Bit mit vorzeichenbehafteten und vorzeichenlosen Varianten zur Verfügung.  In der Praxis gibt es unterschiedliche interne Darstellungen, je nachdem, welcher Integer-Wert zur Laufzeit tatsächlich verwendet wird.

\subsection{Listen}


\subsection{Schlüssel-/Wert-Paare}
...
In \Csharp wird um eine Instanz eines Typs zu erzeugen der Konstruktor dieses Typs mit dem new Operator aufgerufen. 
