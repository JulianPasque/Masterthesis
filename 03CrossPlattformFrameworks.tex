...
\lstinputlisting[label={lst:TabbedPage},caption={Eine Xamarin.Forms TabbedPage definition}, language=XML]{SourceCode/XamarinFormsTabbedPage.XAML}
\end{minipage}
...
\begin{minipage}{\linewidth}
\lstinputlisting[label={lst:FlyOutPage},caption={Eine Xamarin.Forms FlyOut definition}, language=XML]{SourceCode/XamarinFormsFlyoutPage.XAML}
\end{minipage}
