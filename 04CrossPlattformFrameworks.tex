...
Gegenüberstellungen von Xamarin.Forms Elementen und Flutter Widgets in Tabellenform werden auch an anderer Stelle in diesem Kapitel zugunsten der Übersichtlichkeit verwendet.  Flutter Widgets, die im Text nicht expliziert aufgeführt werden,  sind den Xamarin.Forms Elementen in Funktionalität und Aussehen nahezu identisch.  Elemente ohne Gegenstück wie beispielsweise die \glq ContentPage\grq{} werden in der Tabelle aufgeführt, aber im weiteren verlaufe der Arbeit nicht mehr erwähnt,  da diese in Flutter nicht repräsentiert und benötigt werden.   Eine vollständige Referenztabelle,  die sich aus allen Einzelbetrachtungen zusammensetzt,  befindet sich in \hyperref[chap:Gegenueberstellung]{Anhang I} .
